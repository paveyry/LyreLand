...
public class ChordDegreeComputerTest {
    ...
    public void CMajorChordToDegree() {
        ...
        ChordDegreeComputer cMajor = new ChordDegreeComputer(new Tonality(C4, Mode.MAJOR, 0, 0, 0));
    ...
    public void CMinorChordToDegree() {
        ChordDegreeComputer cMinor = new ChordDegreeComputer(new Tonality(C4, Mode.MINOR, -1, -3, 1));
    ...
    public void GbMajorChordToDegree() {
        ChordDegreeComputer gBMajor = new ChordDegreeComputer(new Tonality(GF4, Mode.MAJOR, -1, -6, 0));
