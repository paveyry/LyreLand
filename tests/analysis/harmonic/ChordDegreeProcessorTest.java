...
public class ChordDegreeProcessorTest {
    ...
    public void CMajorChordToDegree() {
        ...
        ChordDegreeProcessor cMajor = new ChordDegreeProcessor(new Tonality(C4, Mode.MAJOR, false, 0, 0));
    ...
    public void CMinorChordToDegree() {
        ChordDegreeProcessor cMinor = new ChordDegreeProcessor(new Tonality(C4, Mode.MINOR, false, 0, 0));
    ...
    public void GbMajorChordToDegree() {
        ChordDegreeProcessor gBMajor = new ChordDegreeProcessor(new Tonality(GF4, Mode.MAJOR, false, 6, 0));
